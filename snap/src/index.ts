...
export const onTransaction: OnTransactionHandler = async ({
  ...
  return {
    content: panel([...ret, divider(),text('Feel like this score is wrong?  Help make Web3 safer by reporting here:'), copyable('https://web3guard.io/'), divider(),
    text('Powered by AnChain.AI'), text('*This score is generated by AnChain.AI’s AI algorithms. Always use your best judgement when transacting in Web3*')]),
  }
}
